...
private:
    ...
    static const Map& EnglishDefaults() {
        ...
        {L"menu.dlss_upscaling", L"DLSS Upscaling"},
            ...
            {L"export.tip.upscale", L"Runs DLSS Super Resolution into the file. Off, the render stays at the source resolution. Without Neural rendering the neural model does not run at all."},
