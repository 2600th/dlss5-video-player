...
private:
    ...
    static const Map& EnglishDefaults() {
        static const Map strings = {
            ...
            {L"menu.compare", L"Compare"}, {L"menu.compare_neural", L"DLSS 5"}, {L"menu.compare_original", L"Original"}, {L"menu.compare_split", L"Split"}, {L"menu.compare_wipe", L"Wipe"},
            {L"menu.compare_blend_less", L"Mix less\t["}, {L"menu.compare_blend_more", L"Mix more\t]"}, {L"menu.compare_swap", L"Swap sides\tX"}, {L"menu.compare_next_mode", L"Next mode\tC"}, {L"menu.compare_previous_mode", L"Previous mode\tShift+C"}, {L"menu.compare_zoom", L"Zoom 2x\tZ"},
            // The compare bar over the control strip, and the tags drawn on the picture.
            {L"compare.mode.neural", L"DLSS 5"}, {L"compare.mode.original", L"Original"}, {L"compare.mode.split", L"Split"}, {L"compare.mode.wipe", L"Wipe"},
            {L"compare.mix", L"Mix"}, {L"compare.swap", L"Swap"}, {L"compare.zoom.fit", L"Fit"},
