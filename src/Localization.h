...
private:
    ...
    static const Map& EnglishDefaults() {
        ...
        {L"menu.dlss_upscaling", L"DLSS Upscaling"},
            ...
            {L"neural.tip.skin", L"Structure term for the skin of the characters Automatic mask finds (default -1.00, which is off).\nMeasured on RenoDX 6.5.3: every negative value and +1.00 render exactly the default picture - the runtime treats them as off - while 0.00 to 0.99 apply the term. It has no effect with Automatic mask off, and it is not face protection: its change lands on faces barely more than Intensity's does."},
