...
private:
    ...
    static const Map& EnglishDefaults() {
        static const Map strings = {
            ...
            {L"menu.youtube_quality", L"YouTube source quality"}, {L"menu.youtube_quality_auto", L"Auto (best available)"},
            {L"menu.youtube_quality_2160", L"2160p"}, {L"menu.youtube_quality_1440", L"1440p"}, {L"menu.youtube_quality_1080", L"1080p"},
            {L"menu.youtube_quality_720", L"720p"}, {L"menu.youtube_quality_480", L"480p"},
