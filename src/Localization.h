...
private:
    ...
    static const Map& EnglishDefaults() {
        ...
        {L"menu.dlss_upscaling", L"DLSS Upscaling"},
            ...
            {L"neural.live.buffering", L"Buffering neural frames"}, {L"warmup.title", L"Starting the neural render"}, {L"toast.rendered", L"Whole video rendered \u00b7 "}, {L"toast.rendered_in", L" of video in "}, {L"warmup.cache", L"checking what is already rendered"}, {L"warmup.runtime", L"checking the neural runtime"}, {L"warmup.model", L"preparing the model on the GPU"}, {L"warmup.first", L"rendering the first second"},
