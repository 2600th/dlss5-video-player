...
if ($version -cne '0.16.0') { throw "This assembler is locked to release 0.16.0; VERSION is '$version'." }
...
function Invoke-FreshReleaseBuild {
    ...
    Write-Host 'Fresh clean DLSSVideoPlayer 0.16.0.0 build verified.'
}
