...
if ($version -cne '0.17.1') { throw "This assembler is locked to release 0.17.1; VERSION is '$version'." }
...
function Invoke-FreshReleaseBuild {
    ...
    Write-Host 'Fresh clean DLSSVideoPlayer 0.17.1.0 build verified.'
}
